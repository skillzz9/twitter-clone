            ...
            <div onClick={() => dispatch(closeCommentModal())}className="absolute top-4 cursor-pointer">
                ...
                <div className="mt-8">
                    <div className="flex space-x-3">
                        <img src={tweetDetails.photoUrl} className="w-12 h-12 object-cover rounded-full"></img>
                        <div>
                ...
                <div className="mt-11">
                <div className="flex space-x-3">
                        <img src={user.photoUrl} className="w-12 h-12 object-cover rounded-full"></img>
                        <div className="w-full">
                        <textarea placeholder="Tweet your reply" className=" text-lg outline-none w-full bg-transparent resize-none" onChange={e => setComment(e.target.value)}></textarea>
                <div className="pt-4 flex justify-between border-t border-gray-700">
                    ...
                    <button onClick={sendComment} disabled={!comment} className="bg-[#1d9bf0] rounded-full px-4 py-1.5 disabled:opacity-50">Tweet</button>
                        </div>
                        </div>
                    </div>
                </div>
